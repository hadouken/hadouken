    ...
    public sealed class KodiNotifierTests
    {
        ...
        public sealed class TheCanNotifyMethod
        {
            ...
            public void Should_Return_True_If_Url_Is_Not_Null_And_Enable_Authentication_Is_False()
            {
                // Given
                var fixture = new KodiNotifierFixture();
                fixture.KeyValueStore.Get<KodiConfig>("kodi.config").Returns(new KodiConfig {Url = new Uri("http://test.uri")});
                var notifier = fixture.CreateNotifier();
            ...
            public void Should_Return_False_If_Url_Is_Not_Null_And_Enable_Authentication_Is_True_And_UserName_Is_Null()
            {
                // Given
                var fixture = new KodiNotifierFixture();
                var config = new KodiConfig {Url = new Uri("http://test.uri"), EnableAuthentication = true, Password = "pwd"};
            ...
            public void Should_Return_False_If_Url_Is_Not_Null_And_Enable_Authentication_Is_True_And_Password_Is_Null()
            {
                // Given
                var fixture = new KodiNotifierFixture();
                var config = new KodiConfig {Url = new Uri("http://test.uri"), EnableAuthentication = true, UserName = "user"};
                fixture.KeyValueStore.Get<KodiConfig>("kodi.config").Returns(config);
                var notifier = fixture.CreateNotifier();
            ...
            [Fact]
            public void Should_Return_True_If_Url_Is_Not_Null_And_Enable_Authentication_Is_True_And_UserName_And_Password_Is_Not_Null()
            {
                // Given
                var fixture = new KodiNotifierFixture();
                var config = new KodiConfig {Url = new Uri("http://test.uri"), EnableAuthentication = true, UserName = "user", Password ="pwd"};
                fixture.KeyValueStore.Get<KodiConfig>("kodi.config").Returns(config);
                var notifier = fixture.CreateNotifier();
