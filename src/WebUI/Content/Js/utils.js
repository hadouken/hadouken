...
function calculateEta(speed, size, progress) {
    if(speed == 0) return "\u221E";
    
    var downloaded = size - (progress / 100.0);
    var remainingSeconds = (size - downloaded) / speed;
    
    if (remainingSeconds > 63072000) return "\u221E";
