...
var dxSTable = function() 
{
	...
	this.paletteURL = ".";
	this.sortAscImage = this.paletteURL+"/img/asc.gif";
	this.sortDescImage = this.paletteURL+"/img/desc.gif";
...
{
	this.paletteURL = url;	
	this.sortAscImage = url+"/img/asc.gif";
	this.sortDescImage = url+"/img/desc.gif";
	if(this.created)
		this.Sort();
}
...
dxSTable.prototype.Sort = function(e) 
{
	...
	if(this.sIndex >= 0) 
	{
		...
		td.style.backgroundImage = "url("+this.paletteURL+"/img/blank.gif)";
	}
