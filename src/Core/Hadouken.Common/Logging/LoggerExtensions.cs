...
namespace Hadouken.Common.Logging {
    public static class LoggerExtensions {
        ...
        public static void Info<T>(this ILogger<T> logger, Exception exception, string message,
        ...
        public static void Warn<T>(this ILogger<T> logger, Exception exception, string message,
            params object[] propertyValues) {
        ...
        public static void Error<T>(this ILogger<T> logger, Exception exception, string message,
            params object[] propertyValues) {
        ...
        public static void Fatal<T>(this ILogger<T> logger, Exception exception, string message,
            params object[] propertyValues) {
