...
using Hadouken.Common.Tests.Fixtures;
using NSubstitute;
using Xunit;
...
namespace Hadouken.Common.Tests.Unit.IO {
    public sealed class GlobberTests {
        ...
        public sealed class TheMatchMethod {
            ...
            public void Should_Ignore_Case_Sensitivity_On_Case_Insensitive_Operative_System(bool isUnix,
                bool shouldFindFile) {
                // Given
            ...
            public void Will_Fix_Root_If_Drive_Is_Missing_By_Using_The_Drive_From_The_Working_Directory() {
                // Given
                var fixture = new GlobberFixture(false);
                fixture.Environment.GetApplicationRoot().Returns("C:/Working/");
                var globber = new Globber(fixture.FileSystem, fixture.Environment);
