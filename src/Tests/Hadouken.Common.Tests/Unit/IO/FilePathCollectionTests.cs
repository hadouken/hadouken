        ...
        public sealed class TheAddMethod {
            ...
            public sealed class WithMultiplePaths {
                ...
                public void Should_Respect_File_System_Case_Sensitivity_When_Adding_Paths(bool caseSensitive,
                    int expectedCount) {
                    // Given
                    var collection = new FilePathCollection(new FilePath[] {"A.TXT", "B.TXT"},
                        new PathComparer(caseSensitive)) {new FilePath[] {"a.txt", "b.txt", "c.txt"}};
        ...
        public sealed class TheRemoveMethod {
            public sealed class WithSinglePath {
                ...
                public void Should_Respect_File_System_Case_Sensitivity_When_Removing_Path(bool caseSensitive,
                    int expectedCount) {
                    // Given
                    var collection = new FilePathCollection(new PathComparer(caseSensitive)) {new FilePath("A.TXT")};
        ...
        public sealed class ThePlusOperator {
            public sealed class WithSinglePath {
                ...
                public void Should_Respect_File_System_Case_Sensitivity_When_Adding_Path() {
                    // Given
                    var collection = new FilePathCollection(new PathComparer(false)) {"B.txt"};
        ...
        public sealed class TheMinusOperator {
            public sealed class WithSinglePath {
                ...
                public void Should_Respect_File_System_Case_Sensitivity_When_Removing_Paths(bool caseSensitive,
                    ...
                    var collection = new FilePathCollection(comparer) {"A.txt", "B.txt"};
                ...
                public void Should_Return_New_Collection() {
                    // Given
                    var collection = new FilePathCollection(new PathComparer(false)) {"A.txt", "B.txt"};
            ...
            public sealed class WithMultiplePaths {
                ...
                public void Should_Respect_File_System_Case_Sensitivity_When_Removing_Paths(bool caseSensitive,
                    int expectedCount) {
                    // Given
                    var collection = new FilePathCollection(new PathComparer(caseSensitive)) {"A.txt", "B.txt", "C.txt"};
                ...
                public void Should_Return_New_Collection() {
                    // Given
                    var collection = new FilePathCollection(new PathComparer(false)) {"A.txt", "B.txt", "C.txt"};
